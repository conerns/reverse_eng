...
/**
 * Marker interface for classes that may be customized by the user by adding
 * custom attributes, e.g. Visit
 * has VisitAttributes, so it implements
 * {@link Customizable}&lt;VisitAttribute&gt;
 * 
